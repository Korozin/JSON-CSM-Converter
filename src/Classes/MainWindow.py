...
class JSONConvert_GUI(object):
    def setupUi(self, JSONConvert_GUI):
        ...
        self.Clear_Button.setGeometry(QtCore.QRect(20, 495, 91, 31))
        ...
        self.Parts_Group_Box.setGeometry(QtCore.QRect(10, 170, 111, 315))
        ...
        self.Dynamic_Button = QtWidgets.QPushButton(self.Parts_Group_Box)
        self.Dynamic_Button.setGeometry(QtCore.QRect(10, 238, 91, 31))
        self.Dynamic_Button.setObjectName("Dynamic_Button")
        self.CSM_Button = QtWidgets.QPushButton(self.Parts_Group_Box)
        self.CSM_Button.setGeometry(QtCore.QRect(10, 273, 91, 31))
        self.CSM_Button.setObjectName("CSM_Button")
        ...
        self.KorOwOzin_Label.setGeometry(QtCore.QRect(10, 610, 100, 18))
    ...
    def retranslateUi(self, JSONConvert_GUI):
        ...
        self.Dynamic_Button.setText(_translate("JSONConvert_GUI", "DYNAMIC"))
        self.CSM_Button.setText(_translate("JSONConvert_GUI", "TO CSM"))
